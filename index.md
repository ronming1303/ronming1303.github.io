...
- [The Impact of Spoofing on Bitcoin Market Microstructure](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5771502)
  - _We find that order book imbalances significantly increase Bitcoin returns at minute and hourly levels. We introduce an innovative methodology for measuring the intensity of spoofing activities._ [<span style="color: red"><u>Poster Here</u></span>](./documents/spoofing_poster.pdf)
...
- [Reinforcement Learning Notes for Financial Studies](./documents/reinforcement_learning_notes_for_finance.pdf):_Notes of methodologies in reinforcement learning algorithms and the applications in financial studies._
  <br><img src="./documents/figure1_RL.PNG" alt="FinRL Deep Reinforcement Learning Framework" style="max-width:100%;margin-top:8px;"> <details markdown="0" style="display:inline-block;vertical-align:top;margin-left:6px;margin-top:6px;"><summary style="cursor:pointer;list-style:none;color:#bbb;font-size:1em;">ⓘ</summary>Source: FinRL: Deep Reinforcement Learning Framework to Automate Trading in Quantitative Finance</details>
...
- [A Sequential Signalling Model of Convertible Debt Call Policy](./documents/A_Sequential_Signaling_Model_of_Convertible_Debt_Call_Policy.pdf)

1. Corporate Finance Seminar Slides
- [For Better or Worse? The Economic Implications of Paid Sick Leave Mandates](./documents/Paid_Sick_Leave_Mandates_Review.pdf)
- [Buy, Invent or Both?](./documents/Buy__Invent_or_Both_.pdf)
- [Does Social Media Reduce Corporate Misconduct?](./documents/Does_Social_Media_Reduce_Misconduct_.pdf)
- [Owner Culture and Pay Inequality within Firms](./documents/Owner_Culture_and_Pay_Inequality_within_Firms.pdf)
- [The Ownership Structure of U.S. Corporations](./documents/The_Ownership_Structure_of_U_S__corporations.pdf)
